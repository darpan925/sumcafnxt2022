...
function pano2vrVrSkin(player,base) {
	...
	function SkinCloner_node_cloner_Class(nodeId, parentScope, ggParent, parameter) {
		...
		el.userData.angle = 0.00;
		el.userData.setOpacityInternal = function(v) {
			me._node_image.material.opacity = v;
		...
		me._node_image.logicBlock_scaling = function() {
			...
			if (me._node_image.ggCurrentLogicStateScaling != newLogicStateScaling) {
				...
				if (me._node_image.ggCurrentLogicStateScaling == 0) {
					me._node_image.userData.transitionValue_scale = {x: 1.15, y: 1.15, z: 1.0};
	...
	'MdVdBGCIo4/UpXwJyLMt6W25RzeecrqsqABZ1WZKEdqs488TKCDiry9qY4XBzNtqgMGGwheS3qPooA3imBoSiDh0EhB+bcY3kUYTv2YRaLxWKxWCwWi8VisVjakP8BZHvmicJF33oAAAAASUVORK5CYII=');
		...
		el.userData.ggWrapText = function(scrollbar) {
			...
			var words = me._ht_video_url_title.userData.ggText.split(' ');
			var line = '';
			for (var i = 0; i < words.length; i++) {
				var testLine;
				if (line == '') {
	...
	'MdVdBGCIo4/UpXwJyLMt6W25RzeecrqsqABZ1WZKEdqs488TKCDiry9qY4XBzNtqgMGGwheS3qPooA3imBoSiDh0EhB+bcY3kUYTv2YRaLxWKxWCwWi8VisVjakP8BZHvmicJF33oAAAAASUVORK5CYII=');
		...
		el.userData.ggWrapText = function(scrollbar) {
			...
			var words = me._ht_video_file_title.userData.ggText.split(' ');
			var line = '';
			for (var i = 0; i < words.length; i++) {
				var testLine;
				if (line == '') {
	...
	'');
		...
		el.userData.ggWrapText = function(scrollbar) {
			...
			var words = me._ht_info_popup.userData.ggText.split(' ');
			var line = '';
			for (var i = 0; i < words.length; i++) {
				var testLine;
				if (line == '') {
	...
	'AAAABJRU5ErkJggg==');
		...
		textureOver = loader.load('data:image/png;base64,'+
	'6TdL+B/gkHeBEJ8GtMgF+kA/xXLsDFhACXswJcUA1wST/ATaUAtzUD3FgP8NaOAG8uCvD2toDeV8aWY/AW36CiATPFazWmYgGn50Sm1xniTT5FvLw8lbpTv8qeSKZ4ANvFw+b6EYy0/uOjXpIkSZIkSZIktfEKpbbYV1i0uZQAAAAASUVORK5CYII=');
		el.userData.materialOver = new THREE.MeshBasicMaterial( {map: textureOver, side: THREE.DoubleSide, transparent: true} );
	...
	'N2J4kUnpNePkxuXg3vrXnSXtBRRa5v14OdVmxa0EOKnKx50h4i/VbjYWXtbzVCxgsdx8G+KNDTuLZtHQpTYF6t+bXPSjb3vdjDw3q+F2vSpEmTJk2abFv+B1jmuY0F3uXXAAAAAElFTkSuQmCC');
		...
		el.userData.ggWrapText = function(scrollbar) {
			...
			var words = me._ht_image_title.userData.ggText.split(' ');
			var line = '';
			for (var i = 0; i < words.length; i++) {
				var testLine;
				if (line == '') {
	...
	'');
		...
		el.userData.angle = 0.00;
		el.userData.setOpacityInternal = function(v) {
			me._ht_node_image.material.opacity = v;
		...
		el.userData.ggWrapText = function(scrollbar) {
			...
			var words = me._ht_node_title.userData.ggText.split(' ');
			var line = '';
			for (var i = 0; i < words.length; i++) {
				var testLine;
				if (line == '') {
